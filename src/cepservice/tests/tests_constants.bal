final xml XML_REQUEST = xml `<ns:consultaCEP xmlns:ns="http://cliente.bean.master.sigep.bsb.correios.com.br/">
                                <cep>00000000</cep>
                            </ns:consultaCEP>`;   
